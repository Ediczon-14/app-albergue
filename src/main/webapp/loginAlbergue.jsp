<%-- 
    Document   : loginAlbergue
    Created on : 03/10/2022, 06:38:43 PM
    Author     : edicz
--%>
                    ...
                    <div class="card">
                        ...
                        <div >
                            <ul class="nav nav-tabs">
                                <li class="nav-item">
                                    <a class="nav-link active text-dark" href="loginAlbergue.jsp">Albergue</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-dark" href="login.jsp">Usuario</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-doby">
                            ...
                            <div class="d-flex justify-content-center form_container">
                                <form method="post" action="ServletSesion">
                                    <input type="hidden" name="tipo" value="sesionAlbergue">	
                                    ...
                                    <div class="container-login100-form-btn">
                                        ...
                                        <br>
                                        <div class="wrap-login100-form-btn">
                                            <p align="center" ><a href="registrarAlbergue.jsp" class="btn btn-dark me-2">Registrar</a>
